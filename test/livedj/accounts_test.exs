defmodule Livedj.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "validates email and password when given" do
      ...
      format_msg = dgettext("errors", "must have the @ sign and no spaces")
    ...
    test "validates maximum values for email and password for security" do
      ...
      assert format_msg in errors_on(changeset).email
      assert max_chars_msg in errors_on(changeset).email
    ...
    test "validates email uniqueness" do
      ...
      assert dgettext("errors", "has already been taken") in errors_on(
               changeset
             ).email
  ...
  describe "apply_user_email/3" do
    ...
    test "requires email to change", %{user: user} do
      ...
      error_msg = dgettext("errors", "did not change")
      assert %{email: [^error_msg]} = errors_on(changeset)
    end
    ...
    test "validates email", %{user: user} do
      ...
      error_msg = dgettext("errors", "must have the @ sign and no spaces")
      assert %{email: [^error_msg]} = errors_on(changeset)
    end
    ...
    test "validates email uniqueness", %{user: user} do
      ...
      error_msg = dgettext("errors", "has already been taken")
      assert error_msg in errors_on(changeset).email
    end
  ...
  describe "update_user_password/3" do
    ...
    test "validates password", %{user: user} do
      ...
      password_confirmation_msg = dgettext("errors", "does not match password")
  ...
  describe "reset_user_password/2" do
    ...
    test "validates maximum values for password for security", %{user: user} do
      ...
      assert error_msg in errors_on(changeset).password
    end
